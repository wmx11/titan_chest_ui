          ...
          <Fade>
            <div className="flex items-center gap-3 flex-wrap">
              <Link href="/dashboards/burn-tracker">
                <a className="md:w-[49%] flex self-stretch">
                  <DarkCard
                    Head={
                    ...
                    Body={
                      <>
                        ...
                        <strong>
                          ...
                          receiving rebases and it grows by 1.92% every 24
                          hours.
                        </strong>
                    ...
                    Body={
                      <>
                        ...
                        <strong>
                          ...
                          There is also a wallet tier list that corresponds to
                          the given token amount in the wallet. The tier list is
                          not official but a community made listing.
                        </strong>
                        <p>
                          Filter wallets by size, order. Find wallets by
                          address.
                        </p>
                      </>
                    }
